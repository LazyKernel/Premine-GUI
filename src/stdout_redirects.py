...
def redirect(string_io_obj: StringIO = None):
    """
    Enables the redirect for the current thread's output to a single cStringIO
    object and returns the object.

    Possible to pass a string io object, takes over object handling
    ...
    string_io_obj = string_io_obj or StringIO()
    thread_proxies[ident] = string_io_obj
